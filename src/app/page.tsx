            ...
            {[
              {
                ...
                desc: "Компьютер болон гар утаснаас ашиглах боломжтой.",
              },
              {
                icon: "📱",
                title: "Gyroscope дэмжлэг",
                desc: "Гар утсаа хөдөлгөн 360° орчныг харах боломжтой.",
              },
              {
                icon: "🗺️",
                title: "Давхрын Зураглал",
                desc: "Та аль давхарт байгаагаа харах боломжтой.",
              },
              {
                icon: "ℹ️",
                title: "Мэдээллийн Цонхнууд",
                desc: "Танхим тус бүрийн мэдээлэл, тоног төхөөрөмж, багтаамжийг харах.",
              },
              {
                icon: "🔗",
                title: "Холбоос хуваалцах",
                desc: "Сонгосон байршлын холбоосыг хуулан бусадтай хуваалцах боломжтой.",
              },
              {
                icon: "🥽",
                title: "VR Горим",
